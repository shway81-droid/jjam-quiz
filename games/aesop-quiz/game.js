...
const QUESTION_POOL = [
  { q: "여름에 논 베짱이와 겨울을 준비한 개미 이야기는?", a: "개미와 베짱이", o: ["여우와 두루미", "사자와 생쥐", "양치기 소년"] },
  { q: "따먹지 못한 포도를 \"신 포도\"라고 한 여우 이야기는?", a: "여우와 신 포도", o: ["개미와 베짱이", "사자와 생쥐", "북풍과 해님"] },
  { q: "나그네의 외투를 누가 벗기나 겨룬 이야기는?", a: "북풍과 해님", o: ["여우와 신 포도", "개미와 베짱이", "사자와 생쥐"] },
  { q: "거짓말로 \"늑대다!\"를 외치다 아무도 안 믿은 이야기는?", a: "양치기 소년", o: ["개미와 베짱이", "북풍과 해님", "여우와 두루미"] },
  { q: "작은 생쥐가 그물에 걸린 사자를 구해준 이야기는?", a: "사자와 생쥐", o: ["여우와 신 포도", "양치기 소년", "북풍과 해님"] },
  { q: "납작한 접시로 여우를 골탕 먹인 두루미 이야기는?", a: "여우와 두루미", o: ["개미와 베짱이", "사자와 생쥐", "양치기 소년"] },
  { q: "매일 황금알을 낳는 거위의 배를 욕심에 가른 이야기는?", a: "황금알을 낳는 거위", o: ["여우와 신 포도", "북풍과 해님", "사자와 생쥐"] },
  { q: "물에 비친 고기를 보고 짖다 물고 있던 고기를 놓친 개 이야기는?", a: "욕심 많은 개", o: ["개미와 베짱이", "양치기 소년", "여우와 두루미"] },
  { q: "좁은 다리에서 서로 안 비켜 물에 빠진 두 염소 이야기는?", a: "고집 센 두 염소", o: ["개미와 베짱이", "사자와 생쥐", "북풍과 해님"] },
  { q: "병 속 물을 돌을 넣어 마신 까마귀 이야기는?", a: "목마른 까마귀", o: ["여우와 신 포도", "양치기 소년", "사자와 생쥐"] },
  { q: "사자 가죽을 쓴 당나귀가 울음소리에 들킨 이야기는?", a: "사자 가죽을 쓴 당나귀", o: ["개미와 베짱이", "북풍과 해님", "여우와 두루미"] },
  { q: "쥐들이 고양이 목에 방울을 달자 했지만 아무도 못 한 이야기는?", a: "고양이 목에 방울 달기", o: ["사자와 생쥐", "여우와 신 포도", "황금알을 낳는 거위"] },
  { q: "소만큼 커지려 배를 부풀리다 터진 개구리 이야기는?", a: "황소와 개구리", o: ["개미와 베짱이", "사자와 생쥐", "북풍과 해님"] },
  { q: "양의 탈을 쓰고 양 떼에 숨어든 늑대 이야기는?", a: "양의 탈을 쓴 늑대", o: ["여우와 신 포도", "개미와 베짱이", "목마른 까마귀"] },
];
