...
const QUESTION_POOL = [
  { q: "<span class='q-emoji'>🐶</span><br>이 동물의 이름은?", a: "개", o: ["하마", "기린", "코뿔소"] },
  { q: "<span class='q-emoji'>🐱</span><br>이 동물의 이름은?", a: "고양이", o: ["얼룩말", "돼지", "말"] },
  { q: "<span class='q-emoji'>🐰</span><br>이 동물의 이름은?", a: "토끼", o: ["곰", "쥐", "고양이"] },
  { q: "<span class='q-emoji'>🦁</span><br>이 동물의 이름은?", a: "사자", o: ["닭", "코끼리", "원숭이"] },
  { q: "<span class='q-emoji'>🐯</span><br>이 동물의 이름은?", a: "호랑이", o: ["판다", "곰", "원숭이"] },
  { q: "<span class='q-emoji'>🐻</span><br>이 동물의 이름은?", a: "곰", o: ["토끼", "사자", "닭"] },
  { q: "<span class='q-emoji'>🐼</span><br>이 동물의 이름은?", a: "판다", o: ["펭귄", "부엉이", "독수리"] },
  { q: "<span class='q-emoji'>🐨</span><br>이 동물의 이름은?", a: "코알라", o: ["코끼리", "쥐", "염소"] },
  { q: "<span class='q-emoji'>🐷</span><br>이 동물의 이름은?", a: "돼지", o: ["펭귄", "곰", "개"] },
  { q: "<span class='q-emoji'>🐮</span><br>이 동물의 이름은?", a: "소", o: ["얼룩말", "개", "기린"] },
  { q: "<span class='q-emoji'>🐔</span><br>이 동물의 이름은?", a: "닭", o: ["사슴", "코알라", "고릴라"] },
  { q: "<span class='q-emoji'>🐧</span><br>이 동물의 이름은?", a: "펭귄", o: ["개", "독수리", "고슴도치"] },
  { q: "<span class='q-emoji'>🦅</span><br>이 동물의 이름은?", a: "독수리", o: ["늑대", "낙타", "얼룩말"] },
  { q: "<span class='q-emoji'>🦉</span><br>이 동물의 이름은?", a: "부엉이", o: ["사슴", "낙타", "여우"] },
  { q: "<span class='q-emoji'>🐺</span><br>이 동물의 이름은?", a: "늑대", o: ["고릴라", "원숭이", "독수리"] },
  { q: "<span class='q-emoji'>🦊</span><br>이 동물의 이름은?", a: "여우", o: ["토끼", "원숭이", "부엉이"] },
  { q: "<span class='q-emoji'>🐗</span><br>이 동물의 이름은?", a: "멧돼지", o: ["펭귄", "코뿔소", "기린"] },
  { q: "<span class='q-emoji'>🐴</span><br>이 동물의 이름은?", a: "말", o: ["코뿔소", "낙타", "판다"] },
  { q: "<span class='q-emoji'>🦓</span><br>이 동물의 이름은?", a: "얼룩말", o: ["고슴도치", "독수리", "부엉이"] },
  { q: "<span class='q-emoji'>🦒</span><br>이 동물의 이름은?", a: "기린", o: ["코뿔소", "판다", "코끼리"] },
  { q: "<span class='q-emoji'>🐘</span><br>이 동물의 이름은?", a: "코끼리", o: ["늑대", "염소", "고슴도치"] },
  { q: "<span class='q-emoji'>🦏</span><br>이 동물의 이름은?", a: "코뿔소", o: ["호랑이", "늑대", "염소"] },
  { q: "<span class='q-emoji'>🦛</span><br>이 동물의 이름은?", a: "하마", o: ["곰", "돼지", "멧돼지"] },
  { q: "<span class='q-emoji'>🐪</span><br>이 동물의 이름은?", a: "낙타", o: ["호랑이", "고릴라", "기린"] },
  { q: "<span class='q-emoji'>🦌</span><br>이 동물의 이름은?", a: "사슴", o: ["코뿔소", "코끼리", "원숭이"] },
  { q: "<span class='q-emoji'>🐐</span><br>이 동물의 이름은?", a: "염소", o: ["하마", "판다", "코알라"] },
  { q: "<span class='q-emoji'>🐒</span><br>이 동물의 이름은?", a: "원숭이", o: ["소", "고슴도치", "쥐"] },
  { q: "<span class='q-emoji'>🦍</span><br>이 동물의 이름은?", a: "고릴라", o: ["늑대", "사슴", "돼지"] },
  { q: "<span class='q-emoji'>🐭</span><br>이 동물의 이름은?", a: "쥐", o: ["코알라", "늑대", "사슴"] },
  { q: "<span class='q-emoji'>🦔</span><br>이 동물의 이름은?", a: "고슴도치", o: ["쥐", "기린", "코뿔소"] },
];
