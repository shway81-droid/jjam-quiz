...
const QUESTION_POOL = [
  { q: "방에서 나갈 때 전기를 아끼려면 무엇을 할까요?", a: "불을 꺼요", o: ["불을 켜 둬요", "문을 열어 둬요", "티브이를 켜요"] },
  { q: "이를 닦을 때 물을 아끼려면 어떻게 할까요?", a: "컵에 받아 써요", o: ["계속 틀어 놔요", "더 세게 틀어요", "뜨겁게 틀어요"] },
  { q: "종이를 아끼려면 어떻게 쓸까요?", a: "양쪽 면에 써요", o: ["한 장만 쓰고 버려요", "구겨서 버려요", "반만 쓰고 버려요"] },
  { q: "가까운 거리를 갈 때 환경에 좋은 방법은?", a: "걷거나 자전거를 타요", o: ["자동차를 타요", "비행기를 타요", "택시를 타요"] },
  { q: "냉장고 문은 어떻게 하는 게 좋을까요?", a: "빨리 닫아요", o: ["오래 열어 둬요", "열어 놓고 봐요", "자주 여닫아요"] },
  { q: "장을 볼 때 비닐봉지 대신 무엇을 쓸까요?", a: "장바구니", o: ["비닐봉지", "종이컵", "플라스틱컵"] },
  { q: "쓰지 않는 전기 플러그는 어떻게 할까요?", a: "뽑아 둬요", o: ["꽂아 둬요", "더 꽂아요", "뜨겁게 해요"] },
  { q: "지구가 점점 더워지는 것을 무엇이라 할까요?", a: "지구온난화", o: ["황사", "홍수", "지진"] },
  { q: "물건을 버리지 않고 다시 쓰는 것을 무엇이라 할까요?", a: "재사용", o: ["낭비", "버리기", "태우기"] },
  { q: "낮에 방을 밝게 하려면 무엇을 이용하면 좋을까요?", a: "햇빛", o: ["전등", "촛불", "손전등"] },
  { q: "에어컨을 켤 때 문과 창문은 어떻게 할까요?", a: "닫아요", o: ["활짝 열어요", "떼어내요", "깨뜨려요"] },
  { q: "숲과 나무는 우리에게 무엇을 만들어 줄까요?", a: "맑은 공기", o: ["매연", "쓰레기", "먼지"] },
]
