...
const QUESTION_POOL = [
  { q: "돈을 쓰지 않고 모아 두는 것을 무엇이라고 할까요?", a: "저축", o: ["낭비", "소비", "교환"] },
  { q: "부모님께 정해진 만큼 받아 쓰는 돈은?", a: "용돈", o: ["월급", "세금", "이자"] },
  { q: "여러 가지 물건을 사고파는 곳은?", a: "시장", o: ["학교", "병원", "공원"] },
  { q: "돈을 안전하게 맡기고 빌리기도 하는 곳은?", a: "은행", o: ["우체국", "도서관", "소방서"] },
  { q: "돈이 없던 옛날, 물건과 물건을 직접 바꾸던 것은?", a: "물물교환", o: ["저축", "기부", "할인"] },
  { q: "동전을 넣어 모으는 돼지 모양 통은?", a: "저금통", o: ["지갑", "필통", "서랍"] },
  { q: "물건을 사고 받는, 얼마 냈는지 적힌 종이는?", a: "영수증", o: ["편지", "광고지", "달력"] },
  { q: "은행에 돈을 맡기면 더 얹어 주는 돈은?", a: "이자", o: ["벌금", "세금", "용돈"] },
  { q: "필요한 사람에게 돈이나 물건을 나누어 주는 것은?", a: "기부", o: ["낭비", "저축", "교환"] },
  { q: "물건값을 깎아 더 싸게 파는 것은?", a: "할인", o: ["이자", "저축", "기부"] },
  { q: "은행에 돈을 넣고 뺀 기록이 적혀 있는 것은?", a: "통장", o: ["영수증", "지도", "시간표"] },
  { q: "물건을 사려고 돈을 쓰는 것을 무엇이라 할까요?", a: "소비", o: ["저축", "생산", "기부"] },
  { q: "가게에서 물건값을 낼 때 쓰는 것은?", a: "돈", o: ["돌멩이", "단추", "색종이"] },
  { q: "꼭 필요한 것에만 돈을 쓰는 알맞은 태도는?", a: "아껴 써요", o: ["다 써 버려요", "마구 사요", "빌려서 써요"] },
]
