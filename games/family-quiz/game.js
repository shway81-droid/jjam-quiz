...
const QUESTION_POOL = [
  { q: "엄마의 여동생을 뭐라고 부를까요?", a: "이모", o: ["고모", "삼촌", "할머니"] },
  { q: "아빠의 남자 형제를 뭐라고 부를까요?", a: "삼촌", o: ["이모", "고모", "조카"] },
  { q: "아빠의 여자 형제를 뭐라고 부를까요?", a: "고모", o: ["이모", "삼촌", "사촌"] },
  { q: "아빠의 아버지를 뭐라고 부를까요?", a: "할아버지", o: ["외할아버지", "삼촌", "고모"] },
  { q: "엄마의 어머니를 뭐라고 부를까요?", a: "외할머니", o: ["할아버지", "이모", "고모"] },
  { q: "언니나 오빠가 낳은 아이는 나에게 무엇일까요?", a: "조카", o: ["사촌", "삼촌", "손자"] },
  { q: "삼촌이나 이모가 낳은 아이는 나와 무슨 사이일까요?", a: "사촌", o: ["조카", "형제", "이웃"] },
  { q: "할아버지·할머니와 부모님, 나까지 여러 대가 함께 사는 가족은?", a: "대가족", o: ["핵가족", "한 사람", "이웃"] },
  { q: "부모님과 자녀만 함께 사는 가족을 뭐라고 할까요?", a: "핵가족", o: ["대가족", "친척", "반 친구"] },
  { q: "엄마와 아빠를 함께 부르는 말은?", a: "부모님", o: ["형제", "친척", "이웃"] },
  { q: "삼촌·이모·사촌처럼 가까운 친족을 통틀어 무엇이라 할까요?", a: "친척", o: ["친구", "이웃", "선생님"] },
]
