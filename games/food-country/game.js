...
const QUESTION_POOL = [
  { q: "피자와 스파게티는 어느 나라 음식일까요?", a: "이탈리아", o: ["일본", "멕시코", "인도"] },
  { q: "초밥(스시)은 어느 나라 음식일까요?", a: "일본", o: ["이탈리아", "멕시코", "프랑스"] },
  { q: "타코는 어느 나라 음식일까요?", a: "멕시코", o: ["일본", "인도", "이탈리아"] },
  { q: "카레는 어느 나라에서 유래한 음식일까요?", a: "인도", o: ["일본", "멕시코", "프랑스"] },
  { q: "김치와 불고기는 어느 나라 음식일까요?", a: "한국", o: ["중국", "일본", "베트남"] },
  { q: "쌀국수(포)는 어느 나라 음식일까요?", a: "베트남", o: ["인도", "멕시코", "이탈리아"] },
  { q: "딤섬과 마파두부는 어느 나라 음식일까요?", a: "중국", o: ["한국", "일본", "인도"] },
  { q: "바게트와 크루아상은 어느 나라 음식일까요?", a: "프랑스", o: ["멕시코", "일본", "베트남"] },
  { q: "햄버거로 유명해진 나라는 어디일까요?", a: "미국", o: ["프랑스", "인도", "베트남"] },
  { q: "케밥은 어느 나라 음식일까요?", a: "터키", o: ["일본", "멕시코", "중국"] },
  { q: "똠얌꿍은 어느 나라 음식일까요?", a: "태국", o: ["프랑스", "미국", "이탈리아"] },
  { q: "소시지와 프레첼로 유명한 나라는 어디일까요?", a: "독일", o: ["일본", "멕시코", "베트남"] },
];
