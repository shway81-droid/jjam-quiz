...
const QUESTION_POOL = [
  { q: "<span class='q-emoji'>🍎</span><br>이 먹거리의 이름은?", a: "사과", o: ["당근", "코코넛", "체리"] },
  { q: "<span class='q-emoji'>🍐</span><br>이 먹거리의 이름은?", a: "배", o: ["배추", "포도", "당근"] },
  { q: "<span class='q-emoji'>🍊</span><br>이 먹거리의 이름은?", a: "귤", o: ["당근", "양파", "복숭아"] },
  { q: "<span class='q-emoji'>🍋</span><br>이 먹거리의 이름은?", a: "레몬", o: ["피망", "체리", "사과"] },
  { q: "<span class='q-emoji'>🍌</span><br>이 먹거리의 이름은?", a: "바나나", o: ["가지", "양파", "아보카도"] },
  { q: "<span class='q-emoji'>🍉</span><br>이 먹거리의 이름은?", a: "수박", o: ["딸기", "고추", "브로콜리"] },
  { q: "<span class='q-emoji'>🍇</span><br>이 먹거리의 이름은?", a: "포도", o: ["브로콜리", "블루베리", "가지"] },
  { q: "<span class='q-emoji'>🍓</span><br>이 먹거리의 이름은?", a: "딸기", o: ["바나나", "당근", "배추"] },
  { q: "<span class='q-emoji'>🫐</span><br>이 먹거리의 이름은?", a: "블루베리", o: ["레몬", "사과", "코코넛"] },
  { q: "<span class='q-emoji'>🍒</span><br>이 먹거리의 이름은?", a: "체리", o: ["당근", "가지", "고구마"] },
  { q: "<span class='q-emoji'>🍑</span><br>이 먹거리의 이름은?", a: "복숭아", o: ["수박", "오이", "올리브"] },
  { q: "<span class='q-emoji'>🥭</span><br>이 먹거리의 이름은?", a: "망고", o: ["체리", "귤", "아보카도"] },
  { q: "<span class='q-emoji'>🍍</span><br>이 먹거리의 이름은?", a: "파인애플", o: ["당근", "키위", "망고"] },
  { q: "<span class='q-emoji'>🥝</span><br>이 먹거리의 이름은?", a: "키위", o: ["당근", "귤", "바나나"] },
  { q: "<span class='q-emoji'>🍅</span><br>이 먹거리의 이름은?", a: "토마토", o: ["배", "아보카도", "올리브"] },
  { q: "<span class='q-emoji'>🥥</span><br>이 먹거리의 이름은?", a: "코코넛", o: ["딸기", "레몬", "가지"] },
  { q: "<span class='q-emoji'>🥑</span><br>이 먹거리의 이름은?", a: "아보카도", o: ["옥수수", "배", "배추"] },
  { q: "<span class='q-emoji'>🍆</span><br>이 먹거리의 이름은?", a: "가지", o: ["체리", "감자", "오이"] },
  { q: "<span class='q-emoji'>🥕</span><br>이 먹거리의 이름은?", a: "당근", o: ["마늘", "체리", "딸기"] },
  { q: "<span class='q-emoji'>🌽</span><br>이 먹거리의 이름은?", a: "옥수수", o: ["코코넛", "가지", "양파"] },
  { q: "<span class='q-emoji'>🥔</span><br>이 먹거리의 이름은?", a: "감자", o: ["피망", "키위", "귤"] },
  { q: "<span class='q-emoji'>🧅</span><br>이 먹거리의 이름은?", a: "양파", o: ["당근", "딸기", "브로콜리"] },
  { q: "<span class='q-emoji'>🧄</span><br>이 먹거리의 이름은?", a: "마늘", o: ["딸기", "가지", "브로콜리"] },
  { q: "<span class='q-emoji'>🥦</span><br>이 먹거리의 이름은?", a: "브로콜리", o: ["고추", "마늘", "옥수수"] },
  { q: "<span class='q-emoji'>🥬</span><br>이 먹거리의 이름은?", a: "배추", o: ["마늘", "복숭아", "가지"] },
  { q: "<span class='q-emoji'>🥒</span><br>이 먹거리의 이름은?", a: "오이", o: ["배추", "코코넛", "고구마"] },
  { q: "<span class='q-emoji'>🫑</span><br>이 먹거리의 이름은?", a: "피망", o: ["파인애플", "블루베리", "양파"] },
  { q: "<span class='q-emoji'>🍠</span><br>이 먹거리의 이름은?", a: "고구마", o: ["키위", "브로콜리", "귤"] },
  { q: "<span class='q-emoji'>🫒</span><br>이 먹거리의 이름은?", a: "올리브", o: ["고구마", "가지", "고추"] },
  { q: "<span class='q-emoji'>🌶️</span><br>이 먹거리의 이름은?", a: "고추", o: ["망고", "코코넛", "옥수수"] },
];
