...
const QUESTION_POOL = [
  { q: "낙타는 주로 어디에 살까요?", a: "사막", o: ["바다", "북극", "밀림"] },
  { q: "북극곰은 주로 어디에 살까요?", a: "북극", o: ["사막", "밀림", "바다"] },
  { q: "펭귄은 주로 어디에 살까요?", a: "남극", o: ["사막", "밀림", "숲"] },
  { q: "원숭이는 주로 어디에 살까요?", a: "밀림", o: ["사막", "북극", "바다"] },
  { q: "사자는 주로 어디에 살까요?", a: "초원", o: ["바다", "북극", "남극"] },
  { q: "상어는 주로 어디에 살까요?", a: "바다", o: ["사막", "초원", "땅속"] },
  { q: "두더지는 주로 어디에 살까요?", a: "땅속", o: ["하늘", "바다", "북극"] },
  { q: "박쥐는 낮에 주로 어디에서 지낼까요?", a: "동굴", o: ["바다", "초원", "남극"] },
  { q: "개구리는 주로 어디에 살까요?", a: "연못", o: ["사막", "북극", "동굴"] },
  { q: "다람쥐는 주로 어디에 살까요?", a: "숲", o: ["바다", "사막", "북극"] },
  { q: "코알라는 주로 어디에서 지낼까요?", a: "나무 위", o: ["바다", "사막", "북극"] },
  { q: "두루미(학)는 먹이를 잡으러 주로 어디에 갈까요?", a: "갯벌", o: ["사막", "북극", "동굴"] },
];
