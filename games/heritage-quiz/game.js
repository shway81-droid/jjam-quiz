...
const QUESTION_POOL = [
  { q: "경주에 있는, 돌로 만든 부처님을 모신 석굴은?", a: "석굴암", o: ["불국사", "첨성대", "수원화성"] },
  { q: "다보탑과 석가탑이 있는 경주의 유명한 절은?", a: "불국사", o: ["석굴암", "경복궁", "광화문"] },
  { q: "별을 관찰하려고 만든 신라의 돌탑은?", a: "첨성대", o: ["다보탑", "석굴암", "거북선"] },
  { q: "조선의 임금이 살던 서울의 대표 궁궐은?", a: "경복궁", o: ["불국사", "수원화성", "첨성대"] },
  { q: "이순신 장군이 만든, 등이 거북 모양인 배는?", a: "거북선", o: ["판옥선", "돛단배", "나룻배"] },
  { q: "세종대왕이 만든 우리 글자는?", a: "훈민정음", o: ["한자", "천자문", "알파벳"] },
  { q: "불국사에 있는 화려한 돌탑은?", a: "다보탑", o: ["첨성대", "석굴암", "남대문"] },
  { q: "정조가 수원에 쌓은 튼튼한 성은?", a: "수원화성", o: ["경복궁", "남한산성", "불국사"] },
  { q: "숭례문이라고도 부르는 서울의 큰 성문은?", a: "남대문", o: ["동대문", "광화문", "독립문"] },
  { q: "경복궁 앞에 있는 큰 문은?", a: "광화문", o: ["남대문", "동대문", "독립문"] },
  { q: "고려 때 부처의 힘으로 나라를 지키려 새긴 목판은?", a: "팔만대장경", o: ["훈민정음", "족보", "지도"] },
  { q: "신라 왕과 귀족이 쓰던 금으로 만든 관은?", a: "금관", o: ["갓", "족두리", "투구"] },
  { q: "옛날 임금의 무덤을 무엇이라고 할까요?", a: "왕릉", o: ["궁궐", "성문", "절"] },
  { q: "비원으로 유명한 조선의 궁궐은?", a: "창덕궁", o: ["수원화성", "불국사", "남대문"] },
]
