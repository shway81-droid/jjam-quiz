...
const QUESTION_POOL = [
  { q: "한글(훈민정음)을 만든 조선의 왕은?", a: "세종대왕", o: ["이순신", "유관순", "장영실"] },
  { q: "거북선으로 임진왜란에서 나라를 지킨 장군은?", a: "이순신", o: ["세종대왕", "안중근", "김구"] },
  { q: "\"대한 독립 만세\"를 외친 3·1운동의 소녀 열사는?", a: "유관순", o: ["신사임당", "선덕여왕", "방정환"] },
  { q: "하얼빈에서 이토 히로부미를 처단한 독립운동가는?", a: "안중근", o: ["이순신", "장영실", "정약용"] },
  { q: "대한민국 임시정부를 이끈 독립운동가는?", a: "김구", o: ["세종대왕", "장영실", "허준"] },
  { q: "물시계와 측우기를 만든 조선의 과학자는?", a: "장영실", o: ["이순신", "김구", "안중근"] },
  { q: "\"동의보감\"을 지은 조선의 유명한 의원은?", a: "허준", o: ["세종대왕", "이순신", "유관순"] },
  { q: "수원 화성을 설계하고 거중기를 만든 학자는?", a: "정약용", o: ["안중근", "유관순", "이순신"] },
  { q: "어린이날을 만들고 어린이를 아끼자고 한 분은?", a: "방정환", o: ["세종대왕", "이순신", "장영실"] },
  { q: "거란의 침입을 귀주에서 크게 물리친 고려의 장군은?", a: "강감찬", o: ["이순신", "안중근", "김유신"] },
  { q: "살수에서 수나라 대군을 물리친 고구려의 장군은?", a: "을지문덕", o: ["강감찬", "이순신", "장보고"] },
  { q: "신라의 삼국 통일에 큰 공을 세운 장군은?", a: "김유신", o: ["을지문덕", "안중근", "정약용"] },
  { q: "청해진을 세우고 바다를 지킨 신라의 인물은?", a: "장보고", o: ["김유신", "이순신", "강감찬"] },
  { q: "율곡 이이의 어머니로 그림과 글씨가 뛰어난 분은?", a: "신사임당", o: ["유관순", "선덕여왕", "방정환"] },
  { q: "전국을 다니며 대동여지도를 만든 사람은?", a: "김정호", o: ["장영실", "정약용", "허준"] },
  { q: "신라 최초의 여왕은?", a: "선덕여왕", o: ["유관순", "신사임당", "명성황후"] },
  { q: "상하이 훙커우 공원에서 폭탄을 던진 독립운동가는?", a: "윤봉길", o: ["안중근", "김구", "이순신"] },
  { q: "한글을 연구하고 가르친 국어학자는?", a: "주시경", o: ["세종대왕", "정약용", "김정호"] },
];
