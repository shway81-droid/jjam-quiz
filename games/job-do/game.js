...
const QUESTION_POOL = [
  { q: "불을 끄고 사람을 구조하는 사람은?", a: "소방관", o: ["경찰관", "의사", "요리사"] },
  { q: "아픈 사람을 진찰하고 치료하는 사람은?", a: "의사", o: ["교사", "농부", "화가"] },
  { q: "학교에서 학생을 가르치는 사람은?", a: "교사", o: ["의사", "경찰관", "요리사"] },
  { q: "도둑을 잡고 질서를 지키는 사람은?", a: "경찰관", o: ["소방관", "의사", "농부"] },
  { q: "음식을 맛있게 만드는 사람은?", a: "요리사", o: ["화가", "가수", "농부"] },
  { q: "비행기를 조종하는 사람은?", a: "조종사", o: ["운전기사", "선장", "의사"] },
  { q: "편지와 택배를 배달하는 사람은?", a: "집배원", o: ["요리사", "교사", "화가"] },
  { q: "머리를 자르고 손질해 주는 사람은?", a: "미용사", o: ["의사", "농부", "가수"] },
  { q: "밭과 논에서 곡식·채소를 기르는 사람은?", a: "농부", o: ["어부", "화가", "조종사"] },
  { q: "바다에서 물고기를 잡는 사람은?", a: "어부", o: ["농부", "요리사", "교사"] },
  { q: "그림을 그리는 사람은?", a: "화가", o: ["가수", "의사", "농부"] },
  { q: "노래를 부르는 사람은?", a: "가수", o: ["화가", "요리사", "경찰관"] },
  { q: "아픈 동물을 치료하는 사람은?", a: "수의사", o: ["의사", "농부", "요리사"] },
  { q: "나무로 집이나 가구를 만드는 사람은?", a: "목수", o: ["화가", "농부", "가수"] },
  { q: "우주선을 타고 우주를 탐험하는 사람은?", a: "우주비행사", o: ["조종사", "선장", "운전기사"] },
  { q: "배를 몰고 바다를 항해하는 사람은?", a: "선장", o: ["조종사", "농부", "화가"] },
];
