...
const QUESTION_POOL = [
  { q: "명절에 입는 우리나라 고유의 옷은?", a: "한복", o: ["기모노", "치파오", "양복"] },
  { q: "세종대왕이 만든 우리나라 글자는?", a: "한글", o: ["한자", "알파벳", "가나"] },
  { q: "발과 손으로 겨루는 우리나라 전통 무술은?", a: "태권도", o: ["유도", "검도", "펜싱"] },
  { q: "두 사람이 샅바를 잡고 넘어뜨리는 우리 전통 운동은?", a: "씨름", o: ["태권도", "축구", "농구"] },
  { q: "북·장구·꽹과리·징을 치며 노는 우리 전통 음악은?", a: "사물놀이", o: ["오케스트라", "합창", "밴드"] },
  { q: "설날에 어른께 큰절하며 인사하는 것을 무엇이라 할까요?", a: "세배", o: ["악수", "포옹", "하이파이브"] },
  { q: "한 사람이 노래로 긴 이야기를 들려주는 우리 전통 공연은?", a: "판소리", o: ["뮤지컬", "오페라", "연극"] },
  { q: "기와나 초가로 지은 우리나라 전통 집은?", a: "한옥", o: ["아파트", "빌라", "통나무집"] },
  { q: "온 가족이 모여 송편을 빚고 보름달을 보는 가을 명절은?", a: "추석", o: ["크리스마스", "핼러윈", "추수감사절"] },
  { q: "겨울에 하늘 높이 연을 띄우는 우리 전통 놀이는?", a: "연날리기", o: ["스키", "수영", "자전거타기"] },
  { q: "윷을 던져 말을 옮기는 우리 전통 놀이는?", a: "윷놀이", o: ["체스", "보드게임", "카드놀이"] },
  { q: "제기를 발로 차서 오래 차기를 겨루는 놀이는?", a: "제기차기", o: ["축구", "농구", "배구"] },
  { q: "태극 무늬와 사괘가 그려진 우리나라 국기는?", a: "태극기", o: ["성조기", "일장기", "유니언잭"] },
  { q: "줄을 매어 서서 타며 높이 오르는 우리 전통 놀이는?", a: "그네뛰기", o: ["시소", "미끄럼틀", "정글짐"] },
];
