...
const QUESTION_POOL = [
  { q: "우리나라의 수도이자 가장 큰 도시는?", a: "서울", o: ["부산", "제주도", "경주"] },
  { q: "우리나라에서 두 번째로 큰, 바다가 있는 항구 도시는?", a: "부산", o: ["서울", "대전", "광주"] },
  { q: "귤과 돌하르방으로 유명한 우리나라에서 가장 큰 섬은?", a: "제주도", o: ["울릉도", "독도", "강화도"] },
  { q: "신라의 옛 수도로 불국사·석굴암이 있는 도시는?", a: "경주", o: ["서울", "부산", "전주"] },
  { q: "제주도에 있는, 우리나라에서 가장 높은 산은?", a: "한라산", o: ["백두산", "설악산", "지리산"] },
  { q: "서울을 지나 서해로 흐르는 큰 강은?", a: "한강", o: ["낙동강", "금강", "영산강"] },
  { q: "우리나라 동쪽 끝에 있는 작은 섬은?", a: "독도", o: ["제주도", "울릉도", "강화도"] },
  { q: "조선의 왕이 살던, 서울에 있는 큰 궁궐은?", a: "경복궁", o: ["불국사", "첨성대", "수원화성"] },
  { q: "단풍과 기암괴석으로 유명한 강원도의 산은?", a: "설악산", o: ["한라산", "지리산", "북한산"] },
  { q: "비빔밥과 한옥마을로 유명한 전라도 도시는?", a: "전주", o: ["부산", "대전", "인천"] },
  { q: "큰 국제공항이 있고 서울과 가까운 항구 도시는?", a: "인천", o: ["경주", "전주", "광주"] },
  { q: "과학 연구소가 많아 과학의 도시로 불리는 곳은?", a: "대전", o: ["부산", "제주도", "경주"] },
  { q: "반달가슴곰이 사는, 경상도와 전라도에 걸친 큰 산은?", a: "지리산", o: ["한라산", "설악산", "북한산"] },
  { q: "사과로 유명하고 낙동강이 흐르는 경상도 도시는?", a: "대구", o: ["서울", "인천", "전주"] },
  { q: "우리나라와 북한을 함께 이르는 반도 이름은?", a: "한반도", o: ["제주도", "울릉도", "독도"] },
];
