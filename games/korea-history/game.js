/* games/korea-history/game.js */

'use strict';

// ── Constants ────────────────────────────────────────────────
const TOTAL_QUESTIONS  = 10;
const TIMEOUT_MS       = 7500;   // per question
...
const QUESTION_POOL = [
  { q: "신라 때 하늘의 별을 살피려 만든 경주의 돌탑은?", a: "첨성대", o: ["불국사", "석굴암", "수원 화성"] },
  { q: "이순신 장군이 임진왜란 때 쓴 거북 모양 배는?", a: "거북선", o: ["판옥선", "첨성대", "측우기"] },
  { q: "세종대왕 때 비의 양을 재려고 만든 기구는?", a: "측우기", o: ["해시계", "거북선", "첨성대"] },
  { q: "1919년 \"대한 독립 만세\"를 외친 운동은?", a: "삼일운동", o: ["훈민정음 창제", "임진왜란", "거북선"] },
  { q: "큰 불상이 있는 경주의 화강암 동굴 절은?", a: "석굴암", o: ["첨성대", "수원 화성", "경복궁"] },
  { q: "고려가 부처의 힘으로 나라를 지키려 만든 목판 경전은?", a: "팔만대장경", o: ["훈민정음", "측우기", "거북선"] },
  { q: "세종대왕이 백성을 위해 만든 우리 글자는?", a: "훈민정음", o: ["팔만대장경", "측우기", "첨성대"] },
  { q: "정약용이 만든 기구로 무거운 돌을 들어 성을 쌓은 것은?", a: "거중기", o: ["측우기", "해시계", "거북선"] },
  { q: "조선의 왕들이 살던 서울의 대표 궁궐은?", a: "경복궁", o: ["불국사", "석굴암", "첨성대"] },
  { q: "신라의 불교 문화를 보여주는 경주의 유명한 절은?", a: "불국사", o: ["경복궁", "수원 화성", "첨성대"] },
  { q: "조선 정조가 계획해 튼튼하게 쌓은 성은?", a: "수원 화성", o: ["첨성대", "석굴암", "불국사"] },
  { q: "해의 그림자로 시각을 알아본 조선의 시계는?", a: "해시계", o: ["측우기", "거북선", "팔만대장경"] },
  { q: "단군이 세웠다고 전해지는 우리나라 최초의 나라는?", a: "고조선", o: ["신라", "백제", "고구려"] },
  { q: "삼국(고구려·백제·신라)을 하나로 통일한 나라는?", a: "신라", o: ["고조선", "고려", "조선"] },
];
