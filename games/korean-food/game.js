...
const QUESTION_POOL = [
  { q: "매콤한 양념에 버무린 배추로 만든 우리 전통 반찬은?", a: "김치", o: ["불고기", "김밥", "잡채"] },
  { q: "밥 위에 여러 나물과 고추장을 넣어 비벼 먹는 음식은?", a: "비빔밥", o: ["냉면", "만두", "떡볶이"] },
  { q: "얇게 썬 소고기를 달콤한 양념에 재워 구운 음식은?", a: "불고기", o: ["김밥", "떡볶이", "순두부찌개"] },
  { q: "떡을 매콤한 양념에 볶은 분식은?", a: "떡볶이", o: ["비빔밥", "잡채", "된장찌개"] },
  { q: "밥과 여러 재료를 김으로 말아 썬 음식은?", a: "김밥", o: ["냉면", "불고기", "삼계탕"] },
  { q: "콩을 발효한 된장을 풀어 끓인 찌개는?", a: "된장찌개", o: ["비빔밥", "김밥", "잡채"] },
  { q: "당면과 채소를 볶아 무친 잔치 음식은?", a: "잡채", o: ["냉면", "떡볶이", "삼계탕"] },
  { q: "어린 닭에 인삼·찹쌀을 넣어 푹 끓인 여름 보양식은?", a: "삼계탕", o: ["김밥", "잡채", "만두"] },
  { q: "차가운 국물에 국수를 말아 먹는 여름 음식은?", a: "냉면", o: ["불고기", "김치", "잡채"] },
  { q: "고기나 채소를 얇은 피로 감싸 빚어 찐 음식은?", a: "만두", o: ["비빔밥", "냉면", "떡볶이"] },
  { q: "추석에 반달 모양으로 빚어 먹는 떡은?", a: "송편", o: ["김밥", "만두", "잡채"] },
  { q: "설날에 흰떡을 썰어 넣고 끓여 먹는 국은?", a: "떡국", o: ["냉면", "된장찌개", "삼계탕"] },
  { q: "부드러운 두부를 넣고 얼큰하게 끓인 찌개는?", a: "순두부찌개", o: ["비빔밥", "김밥", "잡채"] },
  { q: "갈비를 양념해 굽거나 찐 고기 음식은?", a: "갈비", o: ["김밥", "떡볶이", "냉면"] },
  { q: "채소·해물을 밀가루 반죽에 부쳐 지진 음식은?", a: "전", o: ["비빔밥", "냉면", "삼계탕"] },
  { q: "동지에 팥을 끓여 만들어 먹는 음식은?", a: "팥죽", o: ["불고기", "김밥", "잡채"] },
  { q: "쌀로 만든 달콤한 우리 전통 음료는?", a: "식혜", o: ["김치", "만두", "불고기"] },
  { q: "무를 얇게 썰어 시원하게 담근 물김치는?", a: "동치미", o: ["불고기", "잡채", "떡볶이"] },
];
