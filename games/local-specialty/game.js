...
const QUESTION_POOL = [
  { q: "'배'로 유명한 전라남도의 고장은?", a: "나주", o: ["보성", "여수", "해남"] },
  { q: "'사과'로 유명한 경상북도의 고장은?", a: "청송", o: ["포항", "경주", "울진"] },
  { q: "제주도에서 많이 나는 과일은?", a: "귤", o: ["배", "복숭아", "포도"] },
  { q: "'한우'로 유명한 강원도의 고장은?", a: "횡성", o: ["춘천", "강릉", "속초"] },
  { q: "'굴비'로 유명한 전라남도의 고장은?", a: "영광", o: ["목포", "순천", "광양"] },
  { q: "'인삼'으로 유명한 충청남도의 고장은?", a: "금산", o: ["천안", "공주", "보령"] },
  { q: "'녹차밭'으로 유명한 전라남도의 고장은?", a: "보성", o: ["나주", "담양", "진도"] },
  { q: "'곶감'으로 유명한 경상북도의 고장은?", a: "상주", o: ["안동", "구미", "영주"] },
  { q: "'전복'으로 유명한 전라남도의 섬 고장은?", a: "완도", o: ["강화도", "울릉도", "거제도"] },
  { q: "'간고등어'로 유명한 경상북도의 고장은?", a: "안동", o: ["영덕", "포항", "문경"] },
  { q: "비빔밥으로 유명한 전라북도의 도시는?", a: "전주", o: ["군산", "익산", "남원"] },
  { q: "닭갈비로 유명한 강원도의 도시는?", a: "춘천", o: ["원주", "동해", "태백"] },
  { q: "'마늘'로 유명한 경상북도의 고장은?", a: "의성", o: ["칠곡", "성주", "고령"] },
  { q: "'양파'로 유명한 전라남도의 고장은?", a: "무안", o: ["곡성", "구례", "장흥"] },
  { q: "'쌀'로 유명한 경기도의 고장은?", a: "이천", o: ["수원", "안양", "부천"] },
  { q: "초당 순두부로 유명한 강원도의 도시는?", a: "강릉", o: ["춘천", "삼척", "철원"] },
  { q: "'과메기'로 유명한 경상북도의 바닷가 도시는?", a: "포항", o: ["안동", "영주", "상주"] },
  { q: "'대게'로 유명한 경상북도의 고장은?", a: "영덕", o: ["의성", "군위", "봉화"] },
  { q: "'참외'로 유명한 경상북도의 고장은?", a: "성주", o: ["경산", "영천", "청도"] },
  { q: "'유자'로 유명한 전라남도의 고장은?", a: "고흥", o: ["화순", "영암", "신안"] },
  { q: "'대나무'로 유명한 전라남도의 고장은?", a: "담양", o: ["곡성", "보성", "강진"] },
  { q: "'딸기'로 유명한 충청남도의 고장은?", a: "논산", o: ["아산", "서산", "당진"] },
  { q: "'오징어'로 유명한 경상북도의 섬은?", a: "울릉도", o: ["강화도", "진도", "마라도"] },
  { q: "'수박'으로 유명한 전라북도의 고장은?", a: "고창", o: ["김제", "부안", "임실"] },
  { q: "호두과자로 유명한 충청남도의 도시는?", a: "천안", o: ["아산", "예산", "서산"] },
];
