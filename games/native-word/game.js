/* games/native-word/game.js — 패턴 A (4지선다 동시반응) — 순우리말 뜻 맞히기 */
'use strict';
...
// ── 순우리말 데이터: 30+ (word=순우리말, opposite=뜻) ───────────
// 뜻은 서로 겹치지 않게 하나로 확정 (보기 모호성 방지)
const ALL_WORDS = [
  { word: '가람', opposite: '강' },
  { word: '미르', opposite: '용' },
  { word: '미리내', opposite: '은하수' },
  { word: '윤슬', opposite: '잔물결' },
  { word: '너울', opposite: '큰 물결' },
  { word: '즈믄', opposite: '천' },
  { word: '가온', opposite: '가운데' },
  { word: '슈룹', opposite: '우산' },
  { word: '나래', opposite: '날개' },
  { word: '다솜', opposite: '사랑' },
  { word: '메', opposite: '산' },
  { word: '별찌', opposite: '별똥별' },
  { word: '새녘', opposite: '동쪽' },
  { word: '마파람', opposite: '남풍' },
  { word: '하늬바람', opposite: '서풍' },
  { word: '된바람', opposite: '북풍' },
  { word: '샛바람', opposite: '동풍' },
  { word: '라온', opposite: '즐거움' },
  { word: '아라', opposite: '바다' },
  { word: '한울', opposite: '하늘' },
  { word: '동무', opposite: '친구' },
  { word: '햇귀', opposite: '햇살' },
  { word: '노고지리', opposite: '종달새' },
  { word: '가시버시', opposite: '부부' },
  { word: '시나브로', opposite: '조금씩' },
  { word: '마중물', opposite: '펌프물' },
  { word: '그루잠', opposite: '다시 든 잠' },
  { word: '단비', opposite: '꼭 필요한 비' },
  { word: '여울', opposite: '빠른 물살' },
  { word: '꽃샘', opposite: '봄추위' },
  { word: '안다미로', opposite: '가득' },
  { word: '온새미로', opposite: '자연 그대로' },
  { word: '하제', opposite: '내일' },
];
...
// 4지선다: 정답(뜻) + 다른 3개의 뜻 (보기는 모두 '뜻'만 — 한자 글자는 보기에 섞지 않음)
function makeChoices(currentPair) {
  const correctName = currentPair.opposite;
  const usedSet = new Set([correctName]);
