...
const QUESTION_POOL = [
  { q: "우리나라를 상징하는 꽃이에요.", a: "무궁화", o: ["장미", "튤립", "민들레"] },
  { q: "가시가 있고 사막에서도 잘 자라요.", a: "선인장", o: ["소나무", "연꽃", "대나무"] },
  { q: "해를 따라 도는 크고 노란 꽃이에요.", a: "해바라기", o: ["튤립", "장미", "국화"] },
  { q: "네 잎이면 행운을 준다고 해요.", a: "네잎클로버", o: ["민들레", "강아지풀", "토끼풀"] },
  { q: "봄에 가장 먼저 노랗게 피는 나무예요.", a: "개나리", o: ["단풍나무", "소나무", "대나무"] },
  { q: "진흙 속에서 자라 물 위에 꽃을 피워요.", a: "연꽃", o: ["선인장", "장미", "해바라기"] },
  { q: "가을에 잎이 빨갛게 물드는 나무예요.", a: "단풍나무", o: ["소나무", "대나무", "야자수"] },
  { q: "겨울에도 잎이 푸른 뾰족잎 나무예요.", a: "소나무", o: ["은행나무", "벚나무", "단풍나무"] },
  { q: "가을에 노랗고 부채 모양 잎이 지는 나무예요.", a: "은행나무", o: ["소나무", "대나무", "감나무"] },
  { q: "곧게 자라고 마디가 있으며 속이 비었어요.", a: "대나무", o: ["장미", "민들레", "해바라기"] },
  { q: "씨앗이 솜털처럼 바람에 날아가요.", a: "민들레", o: ["장미", "튤립", "소나무"] },
  { q: "봄에 분홍 꽃잎이 흩날리는 나무예요.", a: "벚나무", o: ["소나무", "대나무", "감나무"] },
  { q: "가시가 있고 향기로운 붉은 꽃이에요.", a: "장미", o: ["민들레", "토끼풀", "강아지풀"] },
  { q: "서리에도 피는 가을의 대표 꽃이에요.", a: "국화", o: ["개나리", "진달래", "나팔꽃"] },
  { q: "아침에 피었다가 낮에 지는 나팔 모양 꽃이에요.", a: "나팔꽃", o: ["해바라기", "장미", "국화"] },
  { q: "알뿌리로 자라며 봄에 피는 컵 모양 꽃이에요.", a: "튤립", o: ["해바라기", "민들레", "소나무"] },
  { q: "봄 산에 분홍빛으로 무리 지어 피는 꽃이에요.", a: "진달래", o: ["국화", "해바라기", "튤립"] },
  { q: "열대 지방에서 자라며 잎이 크고 넓은 나무예요.", a: "야자수", o: ["소나무", "개나리", "대나무"] },
];
