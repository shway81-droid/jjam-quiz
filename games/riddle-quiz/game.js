...
const QUESTION_POOL = [
  { q: "다리가 넷이지만 걷지 못하는 것은?", a: "책상", o: ["강아지", "말", "거미"] },
  { q: "먹으면 먹을수록 많아지는 것은?", a: "나이", o: ["밥", "물", "사탕"] },
  { q: "위에서 아래로 자라는 얼음은?", a: "고드름", o: ["눈사람", "나무", "꽃"] },
  { q: "자기 몸을 태워 둘레를 밝히는 것은?", a: "촛불", o: ["전등", "해", "별"] },
  { q: "날개가 있어도 날지 못하고 바람을 일으키는 것은?", a: "선풍기", o: ["새", "나비", "비행기"] },
  { q: "아침에는 네 발, 점심에는 두 발, 저녁에는 세 발로 걷는 것은?", a: "사람", o: ["개", "거미", "새"] },
  { q: "구멍이 많아도 물을 잘 머금는 것은?", a: "스펀지", o: ["그릇", "컵", "항아리"] },
  { q: "등에 지고 다니지만 옷은 아닌 것은?", a: "가방", o: ["모자", "신발", "양말"] },
  { q: "낮에는 숨었다가 밤에 반짝이는 하늘의 것은?", a: "별", o: ["해", "구름", "무지개"] },
  { q: "비가 올 때 펴서 쓰는 것은?", a: "우산", o: ["모자", "부채", "책"] },
  { q: "얼굴은 있어도 눈·코·입이 없고 시간을 알려주는 것은?", a: "시계", o: ["거울", "달력", "사진"] },
  { q: "깎을수록 짧아지고 글씨를 쓰는 것은?", a: "연필", o: ["볼펜", "지우개", "자"] },
  { q: "높이 오를수록 더 추워지는 곳은?", a: "산", o: ["바다", "사막", "들판"] },
  { q: "펼치면 이야기가 가득해 읽는 것은?", a: "책", o: ["공책", "연필", "가방"] },
];
