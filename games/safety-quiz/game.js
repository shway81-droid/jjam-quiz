...
const QUESTION_POOL = [
  { q: "길을 안전하게 건너는 곳은 어디일까요?", a: "횡단보도", o: ["놀이터", "주차장", "운동장"] },
  { q: "불이 났을 때 거는 전화번호는?", a: "119", o: ["112", "114", "100"] },
  { q: "위험하거나 도둑을 봤을 때 경찰에 거는 번호는?", a: "112", o: ["119", "114", "100"] },
  { q: "자전거나 킥보드를 탈 때 머리를 지켜 주는 것은?", a: "헬멧", o: ["장갑", "목도리", "우산"] },
  { q: "자동차를 타면 꼭 매야 하는 것은?", a: "안전벨트", o: ["신발끈", "목걸이", "손목시계"] },
  { q: "횡단보도를 건너도 되는 신호등 색은?", a: "초록불", o: ["빨간불", "노란불", "회색불"] },
  { q: "불을 끌 때 쓰는 도구는?", a: "소화기", o: ["청소기", "선풍기", "다리미"] },
  { q: "지진이 나면 몸을 숨기기 좋은 곳은?", a: "책상 아래", o: ["창문 앞", "승강기 안", "옥상 위"] },
  { q: "물놀이할 때 몸이 물에 뜨게 도와주는 것은?", a: "구명조끼", o: ["우비", "수건", "모자"] },
  { q: "낯선 사람이 따라오라고 하면 어떻게 할까요?", a: "따라가지 않아요", o: ["얼른 따라가요", "차에 함께 타요", "선물을 받아요"] },
  { q: "계단을 오르내릴 때 손으로 잡는 것은?", a: "난간", o: ["커튼", "전등", "액자"] },
]
