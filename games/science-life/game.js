...
const QUESTION_POOL = [
  { q: "알에서 깨어난 올챙이가 자라면 무엇이 될까요?", a: "개구리", o: ["물고기", "뱀", "도마뱀"] },
  { q: "배추흰나비의 애벌레가 번데기를 거쳐 되는 것은?", a: "나비", o: ["메뚜기", "개구리", "물고기"] },
  { q: "암탉이 알을 품으면 그 알에서 나오는 것은?", a: "병아리", o: ["강아지", "송아지", "올챙이"] },
  { q: "씨앗을 심으면 가장 먼저 돋아 나오는 것은?", a: "싹", o: ["꽃", "열매", "단풍"] },
  { q: "올챙이가 개구리가 될 때 가장 먼저 생기는 것은?", a: "뒷다리", o: ["날개", "비늘", "더듬이"] },
  { q: "나비의 한살이 순서로 맞는 것은?", a: "알-애벌레-번데기-나비", o: ["알-번데기-애벌레-나비", "애벌레-알-나비-번데기", "나비-번데기-애벌레-알"] },
  { q: "강낭콩이 싹이 튼 뒤 잘 자라 마지막에 맺는 것은?", a: "열매", o: ["번데기", "비늘", "깃털"] },
  { q: "개구리가 물속에 낳는 것은?", a: "알", o: ["새끼", "우유", "꿀"] },
  { q: "매미 애벌레는 어른벌레가 되기 전 오래도록 어디에서 살까요?", a: "땅속", o: ["물속", "나무 꼭대기", "하늘"] },
  { q: "동물이 태어나 자라고 자손을 남기는 과정을 무엇이라 할까요?", a: "한살이", o: ["먹이사슬", "광합성", "겨울잠"] },
  { q: "번데기 시기 없이 애벌레가 바로 어른벌레를 닮아 자라는 곤충은?", a: "메뚜기", o: ["나비", "벌", "파리"] },
  { q: "봄에 나뭇가지에서 새로 돋는 연한 잎을 무엇이라 할까요?", a: "새순", o: ["단풍", "낙엽", "열매"] },
];
