...
const QUESTION_POOL = [
  { q: "무엇을 보는 감각기관은?", a: "눈", o: ["귀", "코", "혀"] },
  { q: "소리를 듣는 감각기관은?", a: "귀", o: ["눈", "코", "혀"] },
  { q: "냄새를 맡는 감각기관은?", a: "코", o: ["눈", "귀", "피부"] },
  { q: "맛을 느끼는 감각기관은?", a: "혀", o: ["눈", "귀", "코"] },
  { q: "차갑고 뜨거움을 느끼는 가장 넓은 감각기관은?", a: "피부", o: ["눈", "귀", "혀"] },
  { q: "눈으로 보는 감각을 무엇이라 할까요?", a: "시각", o: ["청각", "후각", "미각"] },
  { q: "귀로 듣는 감각을 무엇이라 할까요?", a: "청각", o: ["시각", "후각", "촉각"] },
  { q: "코로 냄새 맡는 감각을 무엇이라 할까요?", a: "후각", o: ["미각", "시각", "청각"] },
  { q: "혀로 맛보는 감각을 무엇이라 할까요?", a: "미각", o: ["후각", "촉각", "시각"] },
  { q: "피부로 느끼는 감각을 무엇이라 할까요?", a: "촉각", o: ["미각", "후각", "청각"] },
  { q: "꽃향기를 맡을 때 쓰는 곳은?", a: "코", o: ["눈", "귀", "혀"] },
  { q: "사탕이 달다는 것을 아는 곳은?", a: "혀", o: ["코", "귀", "눈"] },
  { q: "무지개 색깔을 아는 것은 어떤 감각일까요?", a: "시각", o: ["청각", "미각", "촉각"] },
  { q: "우리 몸의 다섯 가지 감각을 무엇이라 할까요?", a: "오감", o: ["사감", "육감", "삼감"] },
]
