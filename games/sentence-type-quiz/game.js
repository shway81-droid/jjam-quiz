/* games/sentence-type-quiz/game.js */
...
const QUESTION_POOL = [
  { q: "\"날씨가 참 좋다.\"처럼 사실을 있는 그대로 알려 주는 문장은?", a: "평서문", o: ["의문문", "감탄문", "명령문"] },
  { q: "\"지금 몇 시야?\"처럼 무언가 물어보는 문장은?", a: "의문문", o: ["평서문", "감탄문", "청유문"] },
  { q: "\"와, 정말 예쁘다!\"처럼 강한 느낌을 나타내는 문장은?", a: "감탄문", o: ["평서문", "의문문", "명령문"] },
  { q: "\"조용히 하세요.\"처럼 무엇을 시키는 문장은?", a: "명령문", o: ["평서문", "의문문", "감탄문"] },
  { q: "\"우리 같이 놀자.\"처럼 함께하자고 권하는 문장은?", a: "청유문", o: ["명령문", "의문문", "감탄문"] },
  { q: "물음표(?)로 끝나는 문장의 종류는?", a: "의문문", o: ["평서문", "감탄문", "명령문"] },
  { q: "마침표로 끝나며 사실을 알려 주는 문장의 종류는?", a: "평서문", o: ["의문문", "감탄문", "청유문"] },
  { q: "느낌표로 끝나며 감정을 강하게 나타내는 문장은?", a: "감탄문", o: ["평서문", "의문문", "명령문"] },
  { q: "\"밥을 먹어라.\"는 무슨 문장일까요?", a: "명령문", o: ["평서문", "의문문", "감탄문"] },
  { q: "\"책을 읽읍시다.\"는 무슨 문장일까요?", a: "청유문", o: ["명령문", "평서문", "감탄문"] },
  { q: "\"너는 어디 사니?\"는 무슨 문장일까요?", a: "의문문", o: ["평서문", "명령문", "감탄문"] },
  { q: "\"나는 학교에 간다.\"는 무슨 문장일까요?", a: "평서문", o: ["의문문", "명령문", "감탄문"] },
]
