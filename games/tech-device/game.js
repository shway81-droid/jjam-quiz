...
const QUESTION_POOL = [
  { q: "<span class='q-emoji'>💻</span><br>이 기기의 이름은?", a: "노트북", o: ["컴퓨터", "키보드", "마우스"] },
  { q: "<span class='q-emoji'>🖥️</span><br>이 기기의 이름은?", a: "컴퓨터", o: ["키보드", "마우스", "스마트폰"] },
  { q: "<span class='q-emoji'>⌨️</span><br>이 기기의 이름은?", a: "키보드", o: ["마우스", "스마트폰", "헤드폰"] },
  { q: "<span class='q-emoji'>🖱️</span><br>이 기기의 이름은?", a: "마우스", o: ["스마트폰", "헤드폰", "프린터"] },
  { q: "<span class='q-emoji'>📱</span><br>이 기기의 이름은?", a: "스마트폰", o: ["헤드폰", "프린터", "카메라"] },
  { q: "<span class='q-emoji'>🎧</span><br>이 기기의 이름은?", a: "헤드폰", o: ["프린터", "카메라", "캠코더"] },
  { q: "<span class='q-emoji'>🖨️</span><br>이 기기의 이름은?", a: "프린터", o: ["카메라", "캠코더", "게임기"] },
  { q: "<span class='q-emoji'>📷</span><br>이 기기의 이름은?", a: "카메라", o: ["캠코더", "게임기", "디스켓"] },
  { q: "<span class='q-emoji'>📹</span><br>이 기기의 이름은?", a: "캠코더", o: ["게임기", "디스켓", "배터리"] },
  { q: "<span class='q-emoji'>🎮</span><br>이 기기의 이름은?", a: "게임기", o: ["디스켓", "배터리", "노트북"] },
  { q: "<span class='q-emoji'>💾</span><br>이 기기의 이름은?", a: "디스켓", o: ["배터리", "노트북", "컴퓨터"] },
  { q: "<span class='q-emoji'>🔋</span><br>이 기기의 이름은?", a: "배터리", o: ["노트북", "컴퓨터", "키보드"] },
]
