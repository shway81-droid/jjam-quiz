...
const QUESTION_POOL = [
  { q: "<span class='q-emoji'>🔨</span><br>이 도구의 이름은?", a: "망치", o: ["드라이버", "도끼", "나사"] },
  { q: "<span class='q-emoji'>🔧</span><br>이 도구의 이름은?", a: "렌치", o: ["드라이버", "갈고리", "나사"] },
  { q: "<span class='q-emoji'>🪛</span><br>이 도구의 이름은?", a: "드라이버", o: ["톱니바퀴", "나사", "갈고리"] },
  { q: "<span class='q-emoji'>🪚</span><br>이 도구의 이름은?", a: "톱", o: ["공구함", "렌치", "드라이버"] },
  { q: "<span class='q-emoji'>🪓</span><br>이 도구의 이름은?", a: "도끼", o: ["드라이버", "갈고리", "공구함"] },
  { q: "<span class='q-emoji'>⛏️</span><br>이 도구의 이름은?", a: "곡괭이", o: ["도끼", "공구함", "드라이버"] },
  { q: "<span class='q-emoji'>🔩</span><br>이 도구의 이름은?", a: "나사", o: ["드라이버", "도끼", "공구함"] },
  { q: "<span class='q-emoji'>⚙️</span><br>이 도구의 이름은?", a: "톱니바퀴", o: ["갈고리", "곡괭이", "나사"] },
  { q: "<span class='q-emoji'>🧰</span><br>이 도구의 이름은?", a: "공구함", o: ["곡괭이", "도끼", "드라이버"] },
  { q: "<span class='q-emoji'>🪝</span><br>이 도구의 이름은?", a: "갈고리", o: ["톱니바퀴", "렌치", "곡괭이"] },
];
