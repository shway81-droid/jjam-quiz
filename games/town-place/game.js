...
const QUESTION_POOL = [
  { q: "책을 빌리거나 조용히 읽으러 가는 곳은?", a: "도서관", o: ["소방서", "우체국", "목욕탕"] },
  { q: "편지나 택배를 부치러 가는 곳은?", a: "우체국", o: ["도서관", "경찰서", "시장"] },
  { q: "불을 끄고 사람을 구하는 분들이 계신 곳은?", a: "소방서", o: ["경찰서", "학교", "은행"] },
  { q: "도둑을 잡고 우리 마을을 지켜 주는 곳은?", a: "경찰서", o: ["소방서", "우체국", "도서관"] },
  { q: "여러 가지 물건을 사고파는 곳은?", a: "시장", o: ["도서관", "소방서", "경찰서"] },
  { q: "기차를 타러 가는 곳은?", a: "기차역", o: ["공항", "항구", "정류장"] },
  { q: "비행기를 타러 가는 곳은?", a: "공항", o: ["기차역", "항구", "터미널"] },
  { q: "배를 타러 가는 곳은?", a: "항구", o: ["공항", "기차역", "도서관"] },
  { q: "예방주사를 맞거나 건강을 살피러 가는 동네 기관은?", a: "보건소", o: ["우체국", "도서관", "시장"] },
  { q: "여러 동물을 구경할 수 있는 곳은?", a: "동물원", o: ["도서관", "소방서", "우체국"] },
  { q: "동네의 여러 일을 도와주고 서류를 떼어 주는 곳은?", a: "주민센터", o: ["소방서", "도서관", "시장"] },
]
