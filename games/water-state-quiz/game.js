/* games/water-state-quiz/game.js */
...
const QUESTION_POOL = [
  { q: "물이 꽁꽁 얼면 무엇이 될까요?", a: "얼음", o: ["수증기", "비", "눈"] },
  { q: "물이 끓으면 되는 눈에 안 보이는 기체는?", a: "수증기", o: ["얼음", "이슬", "서리"] },
  { q: "얼음이 녹으면 무엇이 될까요?", a: "물", o: ["수증기", "눈", "구름"] },
  { q: "물이 기체가 되어 공기 중으로 날아가는 것은?", a: "증발", o: ["응결", "얼음", "단단"] },
  { q: "수증기가 차가워져 다시 물방울이 되는 것은?", a: "응결", o: ["증발", "얼음", "끓음"] },
  { q: "새벽에 풀잎에 맺힌 물방울은?", a: "이슬", o: ["얼음", "눈", "우박"] },
  { q: "겨울철 하늘에서 내리는, 얼어서 하얀 것은?", a: "눈", o: ["비", "이슬", "수증기"] },
  { q: "물·얼음·수증기 중 단단한 고체는?", a: "얼음", o: ["물", "수증기", "비"] },
  { q: "물·얼음·수증기 중 흐르는 액체는?", a: "물", o: ["얼음", "수증기", "서리"] },
  { q: "물·얼음·수증기 중 눈에 안 보이는 기체는?", a: "수증기", o: ["물", "얼음", "눈"] },
  { q: "추운 날 유리창에 맺힌 물방울은 수증기가 무엇으로 변한 것일까요?", a: "물방울", o: ["얼음", "불", "공기"] },
  { q: "빨래가 마르는 것은 물이 무엇으로 변했기 때문일까요?", a: "수증기", o: ["얼음", "눈", "이슬"] },
]
