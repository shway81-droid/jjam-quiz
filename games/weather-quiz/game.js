...
const QUESTION_POOL = [
  { q: "하늘에서 하얀 얼음 조각이 소복이 내려요.", a: "눈", o: ["비", "우박", "안개"] },
  { q: "하늘에서 물방울이 뚝뚝 떨어져요.", a: "비", o: ["눈", "바람", "무지개"] },
  { q: "해가 쨍쨍하고 구름이 거의 없어요.", a: "맑음", o: ["흐림", "비", "눈"] },
  { q: "번쩍하고 우르릉 소리가 나요.", a: "천둥번개", o: ["맑음", "안개", "무지개"] },
  { q: "비가 온 뒤 하늘에 일곱 빛깔 띠가 떠요.", a: "무지개", o: ["눈", "우박", "바람"] },
  { q: "주변이 뿌옇게 흐려 멀리가 잘 안 보여요.", a: "안개", o: ["맑음", "무지개", "천둥번개"] },
  { q: "나뭇가지가 흔들릴 만큼 세게 불어요.", a: "바람", o: ["눈", "무지개", "안개"] },
  { q: "여름에 갑자기 세차게 쏟아지다 그쳐요.", a: "소나기", o: ["눈", "안개", "서리"] },
  { q: "하늘에서 작고 단단한 얼음 알갱이가 떨어져요.", a: "우박", o: ["비", "안개", "무지개"] },
  { q: "추운 날 아침, 풀잎에 하얗게 얼음이 껴요.", a: "서리", o: ["무지개", "바람", "소나기"] },
  { q: "구름이 잔뜩 껴 해가 안 보여요.", a: "흐림", o: ["맑음", "무지개", "천둥번개"] },
  { q: "여름에 큰비와 강한 바람을 몰고 와요.", a: "태풍", o: ["서리", "무지개", "이슬"] },
  { q: "맑은 밤이 지나 아침 풀잎에 맺힌 물방울이에요.", a: "이슬", o: ["우박", "태풍", "무지개"] },
  { q: "빙글빙글 도는 아주 센 바람 기둥이에요.", a: "회오리바람", o: ["안개", "무지개", "이슬"] },
  { q: "공기가 차가워 입김이 나고 몸이 떨려요.", a: "추위", o: ["더위", "무지개", "비"] },
  { q: "햇볕이 뜨거워 땀이 나고 덥게 느껴져요.", a: "더위", o: ["추위", "안개", "눈"] },
];
