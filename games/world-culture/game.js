...
const QUESTION_POOL = [
  { q: "인도 여성이 몸에 길게 둘러 입는 전통 옷은?", a: "사리", o: ["기모노", "한복", "치파오"] },
  { q: "일본의 전통 옷은?", a: "기모노", o: ["한복", "사리", "아오자이"] },
  { q: "중국의 전통 옷은?", a: "치파오", o: ["기모노", "한복", "사리"] },
  { q: "베트남의 전통 옷은?", a: "아오자이", o: ["기모노", "사리", "치파오"] },
  { q: "스페인의 정열적인 전통 춤은?", a: "플라멩코", o: ["발레", "탱고", "왈츠"] },
  { q: "아르헨티나에서 시작된, 둘이 추는 춤은?", a: "탱고", o: ["플라멩코", "발레", "왈츠"] },
  { q: "멕시코 사람들이 쓰는 챙 넓은 전통 모자는?", a: "솜브레로", o: ["베레모", "중절모", "갓"] },
  { q: "이누이트(에스키모)가 눈과 얼음으로 지은 집은?", a: "이글루", o: ["한옥", "텐트", "아파트"] },
  { q: "몽골 유목민이 사는 둥근 천막집은?", a: "게르", o: ["이글루", "한옥", "아파트"] },
  { q: "브라질의 화려한 거리 축제는?", a: "카니발", o: ["추석", "핼러윈", "설날"] },
  { q: "서양에서 10월 31일에 귀신 분장을 하는 날은?", a: "핼러윈", o: ["추석", "설날", "카니발"] },
  { q: "중국에서 설에 나쁜 기운을 쫓으려 터뜨리는 것은?", a: "폭죽", o: ["연날리기", "쥐불놀이", "제기차기"] },
];
