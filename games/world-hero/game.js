...
const QUESTION_POOL = [
  { q: "노예 해방을 이끈 미국의 대통령은?", a: "링컨", o: ["간디", "에디슨", "나이팅게일"] },
  { q: "전구를 발명한 미국의 발명가는?", a: "에디슨", o: ["아인슈타인", "링컨", "모차르트"] },
  { q: "상대성 이론으로 유명한 과학자는?", a: "아인슈타인", o: ["에디슨", "피카소", "콜럼버스"] },
  { q: "비폭력 운동으로 인도를 이끈 지도자는?", a: "간디", o: ["링컨", "만델라", "나이팅게일"] },
  { q: "전쟁터에서 아픈 병사를 돌본 간호사는?", a: "나이팅게일", o: ["헬렌켈러", "퀴리부인", "간디"] },
  { q: "보지도 듣지도 못했지만 훌륭히 배운 미국의 여성은?", a: "헬렌켈러", o: ["나이팅게일", "퀴리부인", "잔다르크"] },
  { q: "어린 나이에 신동으로 불린 오스트리아의 작곡가는?", a: "모차르트", o: ["피카소", "라이트형제", "에디슨"] },
  { q: "독특한 그림으로 유명한 스페인의 화가는?", a: "피카소", o: ["모차르트", "에디슨", "아인슈타인"] },
  { q: "처음으로 비행기를 만들어 하늘을 난 형제는?", a: "라이트형제", o: ["에디슨", "콜럼버스", "링컨"] },
  { q: "아메리카 대륙에 도착한 탐험가는?", a: "콜럼버스", o: ["간디", "링컨", "에디슨"] },
  { q: "차별에 맞서 남아프리카를 이끈 지도자는?", a: "만델라", o: ["간디", "링컨", "나이팅게일"] },
  { q: "라듐을 발견해 노벨상을 받은 과학자는?", a: "퀴리부인", o: ["나이팅게일", "헬렌켈러", "아인슈타인"] },
  { q: "떨어지는 사과로 중력을 알아낸 영국의 과학자는?", a: "뉴턴", o: ["에디슨", "피카소", "콜럼버스"] },
  { q: "전화기를 발명한 사람은?", a: "벨", o: ["에디슨", "라이트형제", "아인슈타인"] },
];
