...
var WORLD_FACTS = [
  ...
  { q: "초밥(스시)으로 유명한 나라는?", a: "일본" },
  { q: "후지산이 있는 나라는?", a: "일본" },
  { q: "캥거루와 코알라가 사는 나라는?", a: "호주" },
  { q: "삼바 축제로 유명한 나라는?", a: "브라질" },
  { q: "아마존 밀림이 넓게 있는 나라는?", a: "브라질" },
  { q: "풍차와 튤립으로 유명한 나라는?", a: "네덜란드" },
  { q: "잉카 유적 마추픽추가 있는 나라는?", a: "페루" },
  { q: "탱고 춤의 나라는?", a: "아르헨티나" },
  { q: "알프스와 시계로 유명한 나라는?", a: "스위스" },
  { q: "빅벤과 버킹엄 궁전이 있는 나라는?", a: "영국" },
  { q: "김치와 한글의 나라는?", a: "대한민국" },
  { q: "태권도가 시작된 나라는?", a: "대한민국" },
  { q: "개선문이 있는 나라는?", a: "프랑스" },
  { q: "산타클로스 마을로 유명한 나라는?", a: "핀란드" },
  { q: "피오르드 해안으로 유명한 북유럽 나라는?", a: "노르웨이" },
  { q: "올림픽이 처음 열린 나라는?", a: "그리스" },
  { q: "파르테논 신전이 있는 나라는?", a: "그리스" },
  { q: "사파리로 유명한 아프리카 나라는?", a: "케냐" },
  { q: "나일강이 흐르는 나라는?", a: "이집트" },
  { q: "판다가 사는 나라는?", a: "중국" },
  { q: "할리우드 영화로 유명한 나라는?", a: "미국" },
  { q: "붉은 광장이 있는 나라는?", a: "러시아" },
  { q: "타코와 솜브레로의 나라는?", a: "멕시코" },
  { q: "코끼리 트래킹으로 유명한 동남아 나라는?", a: "태국" },
  { q: "소를 신성하게 여기고 카레로 유명한 나라는?", a: "인도" }
];
var COUNTRY_POOL = ["대한민국","일본","중국","미국","프랑스","이탈리아","영국","독일","스페인","이집트","인도","브라질","호주","캐나다","러시아","멕시코","태국","그리스","네덜란드","스위스","케냐","페루","아르헨티나","노르웨이","핀란드","터키"];
...
function generateQuestion() {
  const f = WORLD_FACTS[rand(0, WORLD_FACTS.length - 1)];
  const expr   = f.q;
  const answer = f.a;

  // Build 3 wrong choices: random distinct countries, none equal to answer
  const wrongSet = new Set();
  while (wrongSet.size < 3) {
    const c = COUNTRY_POOL[rand(0, COUNTRY_POOL.length - 1)];
    if (c !== answer && !wrongSet.has(c)) {
      wrongSet.add(c);
    }
  }
